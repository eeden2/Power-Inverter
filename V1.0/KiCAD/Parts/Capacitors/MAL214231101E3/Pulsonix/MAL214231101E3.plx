...
(library Library_1
	...
	(patternDef "CAPPRD350W60D850H1300" (originalName "CAPPRD350W60D850H1300")
		...
		(layerContents (layerNumRef 28)
			(arc (pt 1.75, 0) (radius 4.25) (startAngle 0.0) (sweepAngle 0.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.75, 0) (radius 4.25) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
	)
	...
	(compDef "MAL214231101E3" (originalName "MAL214231101E3") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "http://www.vishay.com/docs/28402/142rhs.pdf")
		(attr "<Component Height>" "13")
		(attr "<STEP Filename>" "MAL214231101E3.stp")
