...
//1481354/1127645/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "TNPW120610R0BEEN" (originalName "TNPW120610R0BEEN")
	...
	(compDef "TNPW120610R0BEEN" (originalName "TNPW120610R0BEEN") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TNPW120610R0BEEN"))
		...
		(attr "Mouser Part Number" "71-TNPW120610R0BEEN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Dale/TNPW120610R0BEEN?qs=WyvL69DJJa%252BeaMORMzQFUg%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "TNPW120610R0BEEN")
		(attr "Description" "Thin Film Resistors - SMD 10ohms .1% 25ppm")
		(attr "<Hyperlink>" "http://www.vishay.com/docs/28758/tnpw_e3.pdf")
		(attr "<Component Height>" "0.65")
		(attr "<STEP Filename>" "TNPW120610R0BEEN.stp")
