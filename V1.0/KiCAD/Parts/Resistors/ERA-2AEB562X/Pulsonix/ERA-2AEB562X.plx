...
//876445/1127645/2.50/2/2/Resistor
...
(library Library_1
	...
	(symbolDef "ERA-2AEB562X" (originalName "ERA-2AEB562X")
	...
	(compDef "ERA-2AEB562X" (originalName "ERA-2AEB562X") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ERA-2AEB562X"))
		...
		(attr "Mouser Part Number" "667-ERA-2AEB562X")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/ERA-2AEB562X?qs=YFwoyZoVY0izNHtAlYQ%2F4g%3D%3D")
		(attr "Manufacturer_Name" "Panasonic")
		(attr "Manufacturer_Part_Number" "ERA-2AEB562X")
		(attr "Description" "Panasonic ERA Series Thin Film Surface Mount Resistor 0402 Case 5.6k +/-0.1% 63mW +/-25ppm/C")
		(attr "<Hyperlink>" "http://industrial.panasonic.com/cdbs/www-data/pdf/RDM0000/AOA0000C307.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "ERA-2AEB562X.stp")
