...
(library Library_1
	...
	(compDef "MAX662AESA+T" (originalName "MAX662AESA+T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "SHDN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://datasheets.maximintegrated.com/en/ds/MAX662A.pdf")
		(attr "Height" "1.75 mm")
	)
