...
//863744/1127645/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MAX662AESA+T" (originalName "MAX662AESA+T")
	...
	(compDef "MAX662AESA+T" (originalName "MAX662AESA+T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "SHDN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MAX662AESA+T"))
		...
		(attr "Mouser Part Number" "700-MAX662AESAT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices-Maxim-Integrated/MAX662AESA%2bT?qs=Mqkh4jHMT8xwCw6RdkV8HQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "MAX662AESA+T")
		(attr "Description" "Switching Voltage Regulators 12V, 30mA Flash Memory Programming Supply")
		(attr "<Hyperlink>" "http://datasheets.maximintegrated.com/en/ds/MAX662A.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MAX662AESA+T.stp")
