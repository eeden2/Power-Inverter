...
(library Library_1
	...
	(symbolDef "KC2520Z12.0000C15XXK" (originalName "KC2520Z12.0000C15XXK")
	...
	(compDef "KC2520Z12.0000C15XXK" (originalName "KC2520Z12.0000C15XXK") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		...
		(compPin "1" (pinName "INH") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "KC2520Z12.0000C15XXK"))
		...
		(attr "<Hyperlink>" "https://www.mouser.cn/datasheet/2/909/clock_z_xz_e-1771825.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "KC2520Z12.0000C15XXK.stp")
